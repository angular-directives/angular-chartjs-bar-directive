  ...
  var compilationFunction = function (templateElement, templateAttributes, transclude) {
    if (templateElement.length === 1) {
      ...
      var potentialOptions = [
        ...
        {key:'data-chartjs-bar-show-stroke', value:'barShowStroke', isBoolean: true},
        {key:'data-chartjs-bar-stroke-width', value:'barStrokeWidth', isNumber: true},
        {key:'data-chartjs-bar-value-spacing', value:'barValueSpacing', isNumber: true},
        {key:'data-chartjs-bar-dataset-spacing', value:'barDatasetSpacing', isNumber: true},
